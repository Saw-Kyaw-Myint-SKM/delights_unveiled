                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" className="w-full lg:w-3/5 lg:pl-10">
                                ...
                                <div className="mt-5">
                                    <div>
                                        ...
                                        <span className="text-xs  text-red-600 font-medium mr-5 uppercase">
                                            {product.categories}
                                        </span>
                                    </div>
                                    <div>
                                        ...
                                        <span className="text-base text-red-500 font-bold mr-5">
                                            {product.total_order}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="">
                                    <button
                                        className="w-full mb-5 sm:w-1/3 bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-2 rounded mt-5 mr-10"
                                    ...
                                    <Link
                                        href="/"
                                        className="w-full sm:w-1/3 bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-10 rounded mt-5"
                                    >
                                        Back
                                    </Link>
                                </div>
