            ...
            <WelcomLayout>
                <section >
                    ...
                    <div
                        ...
                        style={{ backgroundImage: "url('/img/leading_photo.png')" }}
                    >
                        <header className="pl-16 pr-16 pt-5 pb-5">
                            <h1 className="text-base md:text-4xl font-bold">Best Collection For Home Decoration</h1>
                            <p className="text-gray-600 text-sm md:text-lg">Lorem, ipsum dolor sit amet consectetur adipisicing elit...</p>
